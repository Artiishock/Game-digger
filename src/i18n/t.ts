...
const en: PhraseMap = {
  ...
  'select volatility':               'Select the volatility level',
  'select volatility desc':          'Choose based on how often and how much the slot pays out winnings in the long run',
  ...
  'settings p1':                         'You can adjust the character speed using four buttons on the screen (turtle, hare, horse, and cheetah). The menu button opens a panel with the following settings:',
  'settings p2':                         '',
...
const es: PhraseMap = {
  ...
  'select volatility':               'Selecciona el nivel de volatilidad',
  'select volatility desc':          'Elige según la frecuencia y el tamaño de los premios que paga la tragamonedas a largo plazo',
  ...
  'settings p1':                         'Puedes ajustar la velocidad del personaje con cuatro botones en la pantalla (tortuga, liebre, caballo y guepardo). El botón de menú abre un panel con los siguientes ajustes:',
  'settings p2':                         '',
  ...
  'additional info p1':                  'En caso de malfunciones del juego, todas las rondas jugadas y sus ganancias se anulan. Cada 24 horas se completan todas las rondas no terminadas. Si “Cobrar” está disponible en el juego, el juego realizará “Cobrar” y la ganancia se acreditará al saldo del jugador. Si el juego espera una acción del jugador, el resultado se calcula como si el jugador hubiera elegido una acción sin riesgo y sin aumentar la apuesta inicial.',
  'additional info p2':                  '',
...
const de: PhraseMap = {
  ...
  'select volatility':               'Volatilitätsstufe wählen',
  'select volatility desc':          'Wähle danach, wie oft und wie viel der Slot langfristig auszahlt',
  ...
  'settings p1':                         'Du kannst die Geschwindigkeit des Charakters mit vier Buttons auf dem Bildschirm einstellen (Schildkröte, Hase, Pferd und Gepard). Der Menübutton öffnet ein Panel mit den folgenden Einstellungen:',
  'settings p2':                         '',
...
const ru: PhraseMap = {
  ...
  'select volatility':               'Выберите уровень волатильности',
  'select volatility desc':          'Выбирайте исходя из того, как часто и сколько слот выплачивает в долгосрочной перспективе',
  ...
  'settings p1':                     'Вы можете регулировать скорость персонажа с помощью четырех кнопок на экране (черепаха, заяц, лошадь и гепард). Кнопка меню открывает панель со следующими настройками:',
  'settings p2':                     '',
...
const tr: PhraseMap = {
  ...
  'select volatility':               'Volatilite seviyesini seçin',
  'select volatility desc':          'Slotun uzun vadede ne sıklıkta ve ne kadar ödeme yaptığına göre seçin',
  ...
  'settings p1':                         'Ekrandaki dört düğmeyi kullanarak karakter hızını ayarlayabilirsiniz (kaplumbağa, tavşan, at ve çita). Menü düğmesi aşağıdaki ayarların bulunduğu paneli açar:',
  'settings p2':                         '',
